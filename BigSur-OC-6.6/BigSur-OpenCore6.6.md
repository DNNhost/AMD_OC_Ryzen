...
Thunderbolt works on cold start, bluetooth works all the time
    ...
    using a Ryzen 9 CPU, such as a 3900X; aka AMD Hackintosh. The contents work with either _Catalina_ or _Big Sur_. The intended SMBIOS is _iMacPro1,1_.
...
### 6. Problems with TB status and M2_1 & M2_2 slots (AKA 'disapparing drives')
